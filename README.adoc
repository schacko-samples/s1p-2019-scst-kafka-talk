...
=== https://github.com/schacko-samples/kafka-summit-london-2022/blob/main/spring-integration-kafka-app/src/main/java/app7/SpringIntegrationKafkaApp.java[spring-integration-kafka-app - Spring Integration Kafka Outbound Channel Adapter and Message Driven Channel Adapter Demo]
